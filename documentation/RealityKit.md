...
> **visionOS 27+, iOS 27+, iPadOS 27+, macOS Golden Gate 27+:** Content renders against the refined Liquid Glass material used for windows and ornaments. In passthrough, the background is the uncontrolled real world — validate legibility in bright, dark, and high-motion environments rather than a fixed test scene, and respect Reduce Transparency, Increase Contrast, and Reduce Motion.
